...
if [0, 2].include?(@kafo.exit_code)
  if !app_value(:upgrade)
    ...
    Kafo::Helpers.certs_gen_instructions_message(@kafo) if Kafo::Helpers.module_enabled?(@kafo, 'foreman_proxy_certs') || Kafo::Helpers.module_enabled?(@kafo, 'cert_generate_archive')
