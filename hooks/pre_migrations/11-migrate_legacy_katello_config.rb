...
LEGACY_CONFIG_NAME = 'katello-installer.yaml'
SCENARIO_NAME = 'katello.yaml'
...
if File.exists?(legacy_config_file)
  ...
  if legacy_config.log_exists?
    ...
    logger.info("Configuration #{legacy_config_file} was successfuly migrated. Installer configuration reload was requested.")
  end
